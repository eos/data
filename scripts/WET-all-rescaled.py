...
fig.tight_layout()
fig.savefig("figures/WET-all-rescaled.pdf", bbox_inches='tight', dpi=300)
fig.savefig("figures/WET-all-rescaled.png", bbox_inches='tight', dpi=300)
