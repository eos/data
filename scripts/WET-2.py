...
wc5WET2 = samples[:,0]
wc6WET2 = samples[:,1]
maskWET2_A = ((wc5WET2 < 2.25 - 0.81 * wc6WET2) & (wc5WET2 > -2.25 - 0.81 * wc6WET2))
maskWET2_B = (wc5WET2 > 2.25 - 0.81 * wc6WET2)
samples_A = samples[maskWET2_A]
weights_A = weights[maskWET2_A] /sum(weights[maskWET2_A])
samples_B = samples[maskWET2_B]
weights_B = weights[maskWET2_B] / sum(weights[maskWET2_B])
...
fig.tight_layout()
fig.savefig("figures/WET-2.pdf", bbox_inches='tight', dpi=300)
fig.savefig("figures/WET-2.png", bbox_inches='tight', dpi=300)