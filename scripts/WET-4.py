...
wc8WET4  = samples[:,3]
wc10WET4 = samples[:,5]
maskWET4_1 = (wc5WET4 > -3.25 - 0.75 * wc6WET4)
maskWET4_2 = ((wc5WET4 < -3.25 - 0.75 * wc6WET4) & (wc8WET4 > 0.35 + 11.25 * wc10WET4))

samples_1 = samples[maskWET4_1]
weights_1 = weights[maskWET4_1] / sum(weights[maskWET4_1])
samples_2 = samples[maskWET4_2]
weights_2 = weights[maskWET4_2] / sum(weights[maskWET4_2])
...
fig.tight_layout()
fig.savefig("figures/WET-4.pdf", bbox_inches='tight', dpi=300)
fig.savefig("figures/WET-4.png", bbox_inches='tight', dpi=300)